...
void main() {
  group('MarkerIconLoaderImpl', () {
    ...
    test('AssetMapBitmap references the correct asset path', () {
      final icon =
          loader.load(IncidentType.animalOnRoad, size: 96) as AssetMapBitmap;
    ...
    test('AssetMapBitmap uses the specified size for width and height', () {
      final icon =
          loader.load(IncidentType.animalOnRoad, size: 48) as AssetMapBitmap;
    ...
    test('different sizes produce different dimensions', () {
      final small =
          loader.load(IncidentType.animalOnRoad, size: 24) as AssetMapBitmap;
      final large =
          loader.load(IncidentType.animalOnRoad, size: 96) as AssetMapBitmap;
    ...
    test('returns an AssetMapBitmap for person road incidents', () {
      final icon = loader.load(IncidentType.personOnRoad, size: 96);
    ...
    test(
      'returns identical instance on repeated call with same args (cache hit)',
      () {
    ...
    test(
      'null hazard type always returns defaultMarker regardless of size',
      () {
